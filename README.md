...
| **Duels** | Blind, as in The Bazaar. Before a duel you see only the rival's name and record, as a silhouette. Their build is revealed when the fight starts, and a win lets you loot from it. The 9 hand-written ghosts are 3 per duel round. Duel loot is bumped up a rarity tier. |
