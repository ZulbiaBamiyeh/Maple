...
export const RAMPS = {
  ...
  coral: ['#ff9c8a', '#e8604f', '#a83a3f'],
  sea: ['#8ff0e0', '#3cb8b0', '#227079'],
  pearl: ['#fffaff', '#f0dcef', '#c3a9c9'],
  brass: ['#ffe29a', '#d9a441', '#8f6424'],
  rust: ['#e39a5c', '#b0592e', '#6b3322'],
  spark: ['#fff7b0', '#ffe066', '#d9a520'],
  witch: ['#c9a2f2', '#8a58c9', '#4e2f80'],
  shade: ['#7d73a8', '#4d4677', '#2a2548'],
